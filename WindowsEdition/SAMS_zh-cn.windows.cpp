	...
	while(o[0]!='E'){
		...
		if(o[0]=='4'&&usr){
			...
			if(o[0]=='7'){
				...
				system("wget https://github.com/XiyuWang2006/StudentAchievementManagementSystem/raw/master/WindowsEdition/SAMS_zh-cn_installer.rar");
				...
				if(!fin){
					...
					cout<<"注意：正常重装系统（请注意是在“正常情况下”）不会导致学生信息的丢失！"<<endl; 
					getch();
				}
			}
		}
